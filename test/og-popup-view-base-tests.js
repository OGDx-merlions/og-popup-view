...
function runBaseTests() {
  og_popup_view_1 = document.getElementById('og_popup_view_1');

  suite('Base Automation Tests for og-popup-view', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-popup-view fixture is created', function() {
      assert.isTrue(document.getElementById('og_popup_view_1') !== null);
    });
